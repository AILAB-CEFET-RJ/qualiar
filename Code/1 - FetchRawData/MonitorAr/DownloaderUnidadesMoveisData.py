...
URL = "https://www.data.rio/datasets/PCRJ::qualidade-do-ar-dados-horários/about?layer=3"
NOME_ARQUIVO_FINAL = "dados_qualidade_ar_unidades_moveis.parquet"
COLUNAS_REMOVER = [
    "objectid",
    "name",
    "rs",
...
ANOS_INTERESE = [2012, 2013, 2014, 2015, 2016, 2017, 2018]
...
def converter_csv_para_parquet(csv_path: Path) -> Path:
    ...
    dataframe = dataframe[dataframe["data"].dt.year.isin(ANOS_INTERESE)]
